  ...
  if (successData) {
    return (
      <div className="min-h-screen pt-32 pb-24 container mx-auto px-6 relative z-10 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-xl text-gray-400 mb-8 font-medium">You're officially registered for the event.</p>
        
        {emailFailed && (
          <div className="bg-orange-500/10 border border-orange-500/20 text-orange-400 px-6 py-4 rounded-xl mb-8 max-w-xl w-full text-sm font-medium">
            Registration successful. We could not send the confirmation email. Please contact the fitness club team.
          </div>
        )}
        ...
        <div className="mt-8 w-full max-w-xl">
          <a 
            href="https://chat.whatsapp.com/JxqCas59Be69t5OdmDu0Hf" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 w-full bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 text-[#25D366] py-4 rounded-xl font-bold tracking-widest transition-colors mb-6"
          >
