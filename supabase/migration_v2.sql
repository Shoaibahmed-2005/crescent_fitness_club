...
-- Update the Registration RPC function
...
BEGIN
    ...
    -- 3. Validate Gender Eligibility (if gender is provided and restricted)
    ...
    IF FOUND THEN
        ...
        UPDATE profiles SET department = p_department, year = p_year WHERE id = v_profile_id;
    ELSE
