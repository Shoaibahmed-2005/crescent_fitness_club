-- Add friendly_id to registrations to permanently store the CFC-2026-XXXX ID
ALTER TABLE registrations ADD COLUMN IF NOT EXISTS friendly_id TEXT;

-- Update the Registration RPC function to store friendly_id
...
BEGIN
    ...
    -- 7. Insert the Registration (now with friendly_id)
    INSERT INTO registrations (sub_event_id, user_id, status, friendly_id)
    VALUES (p_sub_event_id, v_profile_id, 'CONFIRMED', v_friendly_id)
